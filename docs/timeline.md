...
- **2026-08-07** — Fix #276: build the pre-push local review surface SPEC 2.0 makes the default trigger *(fix/276-pre-push-surface)* — [decisions-branches/fix__276-pre-push-surface.md](decisions-branches/fix__276-pre-push-surface.md)
- *... 10 more decisions ...*

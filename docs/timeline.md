...
- **2026-08-07** — Fork PRs: the Action's gate stops being a job conclusion, so it can finally be neutral (SPEC §6.5) *(fix/fork-checks-neutral)* — [decisions-branches/fix__fork-checks-neutral.md](decisions-branches/fix__fork-checks-neutral.md)
- *... 4 more decisions ...*

...
- **2026-08-24** — Adopt TypeScript 7 on dev, fix the #295 job-rename test break, and repair the corrupted file-structure.md tree root *(fix/dev-ts7-green)* — [decisions-branches/fix__dev-ts7-green.md](decisions-branches/fix__dev-ts7-green.md)
- *... 17 more decisions ...*

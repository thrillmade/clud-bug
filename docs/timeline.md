...
- **2026-09-15** — logmind-self-update.yml notifies on failure (#333) *(fix/333-self-update-failure-notice)* — [decisions-branches/fix__333-self-update-failure-notice.md](decisions-branches/fix__333-self-update-failure-notice.md)
- *... 1 more decision ...*
